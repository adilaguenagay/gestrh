...
@Component({
  selector: 'app-affectation-list-admin',
  templateUrl: './affectation-list-admin.component.html'
})
export class AffectationListAdminComponent implements OnInit {

    protected fileName = 'Affectation';
    ...
    uniteMeres: Array<UniteStructurelleDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AffectationDto>();
    ...
    public async edit(dto: AffectationDto) {
    ...
    public async view(dto: AffectationDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: AffectationDto) {
    ...
    public async duplicate(dto: AffectationDto) {
    ...
    public exportPdf(dto: AffectationDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'uniteMere?.code', header: 'Unite mere'},
        ];
    }
    ...
    public async loadUniteMere(){
        this.uniteStructurelleService.findAllOptimized().subscribe(uniteMeres => this.uniteMeres = uniteMeres, error => console.log(error))
    }


	public initDuplicate(res: AffectationDto) {
	}
            ...
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						...
						'Unite mere': e.uniteMere?.code ,
					}
				});

            this.criteriaData = [{
            //'Employee': this.criteria.employee?.ppr ? this.criteria.employee?.ppr : environment.emptyForExport ,
            //'Unite mere': this.criteria.uniteMere?.code ? this.criteria.uniteMere?.code : environment.emptyForExport ,
            }];
			}
    ...
    get selections(): Array<AffectationDto> {
        return this.service.selections;
    }

    set selections(value: Array<AffectationDto>) {
