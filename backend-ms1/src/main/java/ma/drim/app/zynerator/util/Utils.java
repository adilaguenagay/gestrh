package ma.drim.app.zynerator.util;

import ma.drim.app.zynerator.audit.AuditEntity;
import ma.drim.app.zynerator.audit.Log;
import ma.drim.app.zynerator.bean.BusinessObject;
import ma.drim.app.zynerator.bean.EnumBean;
