...
export class FonctionListAdminComponent implements OnInit {

    protected fileName = 'Fonction';
    ...
    constructor( private service: FonctionAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<FonctionDto>();
    ...
    public async edit(dto: FonctionDto) {
    ...
    public async view(dto: FonctionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: FonctionDto) {
    ...
    public async duplicate(dto: FonctionDto) {
    ...
    public exportPdf(dto: FonctionDto): void {
...
// add
    ...
    get selections(): Array<FonctionDto> {
        return this.service.selections;
    }

    set selections(value: Array<FonctionDto>) {
