function fn() {
    ...
    const urlDev = 'jdbc:mysql://localhost:3306/rhdb';
    ...
    config.affectationUrl = config.adminUri + 'affectation/';
    config.situationFamilialeUrl = config.adminUri + 'situationFamiliale/';
    config.gradeUrl = config.adminUri + 'grade/';
    config.fonctionUrl = config.adminUri + 'fonction/';
    config.typeDiplomeUrl = config.adminUri + 'typeDiplome/';
    config.localUrl = config.adminUri + 'local/';
    config.genreUrl = config.adminUri + 'genre/';
    config.employeeUrl = config.adminUri + 'employee/';
    config.uniteStructurelleUrl = config.adminUri + 'uniteStructurelle/';
    config.diplomeUrl = config.adminUri + 'diplome/';
