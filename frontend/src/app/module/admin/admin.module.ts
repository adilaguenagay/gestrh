...
import { AffectationAdminModule } from './view/affectation/affectation-admin.module';
import { AffectationAdminRoutingModule } from './view/affectation/affectation-admin-routing.module';
import { DiplomeAdminModule } from './view/diplome/diplome-admin.module';
import { DiplomeAdminRoutingModule } from './view/diplome/diplome-admin-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    BadgeModule,
    MultiSelectModule,
  AffectationAdminModule,
  AffectationAdminRoutingModule,
  DiplomeAdminModule,
  DiplomeAdminRoutingModule,
  ConfigAdminModule,
