...
export class GradeListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<GradeDto>();
    ...
    public async edit(dto: GradeDto) {
    ...
    public async view(dto: GradeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: GradeDto) {
    ...
    public async duplicate(dto: GradeDto) {
    ...
    public exportPdf(dto: GradeDto): void {
...
// add
    ...
    get selections(): Array<GradeDto> {
        return this.service.selections;
    }

    set selections(value: Array<GradeDto>) {
