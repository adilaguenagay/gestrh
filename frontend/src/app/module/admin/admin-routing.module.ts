            ...
            [
                {
                    ...
                    children: [
                        ...
                        {
                            path: 'affectation',
                            loadChildren: () => import('./view/affectation/affectation-admin-routing.module').then(x => x.AffectationAdminRoutingModule),
                            canActivate: [AuthGuard],
                        },
                        {
                            path: 'diplome',
                            loadChildren: () => import('./view/diplome/diplome-admin-routing.module').then(x => x.DiplomeAdminRoutingModule),
                            canActivate: [AuthGuard],
                        },
                        {
                            path: 'config',
