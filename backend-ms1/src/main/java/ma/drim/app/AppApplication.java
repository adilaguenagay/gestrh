...
import ma.drim.app.zynerator.security.bean.*;
import ma.drim.app.zynerator.security.common.AuthoritiesConstants;
import ma.drim.app.zynerator.security.service.facade.*;
...
public class AppApplication {
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        modelPermissions.add(new ModelPermission("Affectation"));
        modelPermissions.add(new ModelPermission("SituationFamiliale"));
        modelPermissions.add(new ModelPermission("Grade"));
        modelPermissions.add(new ModelPermission("Fonction"));
        modelPermissions.add(new ModelPermission("TypeDiplome"));
        modelPermissions.add(new ModelPermission("Local"));
        modelPermissions.add(new ModelPermission("Genre"));
        modelPermissions.add(new ModelPermission("Employee"));
        modelPermissions.add(new ModelPermission("UniteStructurelle"));
