...
@Component({
  selector: 'app-unite-structurelle-list-admin',
  templateUrl: './unite-structurelle-list-admin.component.html'
})
export class UniteStructurelleListAdminComponent implements OnInit {

    protected fileName = 'UniteStructurelle';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<UniteStructurelleDto>();
    ...
    public async edit(dto: UniteStructurelleDto) {
    ...
    public async view(dto: UniteStructurelleDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: UniteStructurelleDto) {
    ...
    public async duplicate(dto: UniteStructurelleDto) {
    ...
    public exportPdf(dto: UniteStructurelleDto): void {
...
// add
    ...
    public async loadUniteMere(){
        this.service.findAllOptimized().subscribe(uniteMeres => this.uniteMeres = uniteMeres, error => console.log(error))
    }


	public initDuplicate(res: UniteStructurelleDto) {
        if (res.employee != null) {
             res.employee.forEach(d => { d.uniteStructurelle = null; d.id = null; });
        }
	}
    ...
    get selections(): Array<UniteStructurelleDto> {
        return this.service.selections;
    }

    set selections(value: Array<UniteStructurelleDto>) {
